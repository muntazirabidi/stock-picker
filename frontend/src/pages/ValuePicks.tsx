...
import { useUniverseTickers, useScoreUniverseWithValuation, useValueScores, useScoringProgress } from '@/hooks/useUniverse'
      ...
      <div className="rounded-xl border border-white/[0.04] bg-gradient-to-br from-[#0c0c0f] to-[#0e0e12] p-6">
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 min-w-[140px]"
            >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] text-zinc-400">
                          Currently processing: <span className="text-emerald-400 font-mono">{progress.current_ticker}</span>
                        </p>
                      </div>
                    </div>
